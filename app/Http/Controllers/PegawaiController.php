...
class PegawaiController extends Controller
{
    ...
    return redirect('/pegawai')->with('success', 'Data pegawai berhasil di update!');
}
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/pegawai')->with('success', 'Data pegawai berhasil di hapus!');
    }
}
